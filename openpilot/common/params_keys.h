...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"ModelBigExecutionTime", {CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION, FLOAT, "0.0"}},
    {"ModelBigSelected", {CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION, BOOL}},
    {"ModelSmallExecutionTime", {CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION, FLOAT, "0.0"}},
